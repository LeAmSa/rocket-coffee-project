...
<div align="center">
  ...
  <div align="center">
  <a href="https://leamsa.github.io/rocket-coffee-project/" target="_blank">
...
The objective was to develop a Coffee homepage example.
...
1. Clone the repo
   ```sh
   git clone https://github.com/LeAmSa/rocket-coffee-project.git
   ```
2. Enter the project folder
   ```sh
   cd rocket-coffee-project
   ```
...
[screenshot]: https://drive.google.com/uc?id=1m9pDOhqidTJ4t5_yvMZTmyOr2ivPBvlP
